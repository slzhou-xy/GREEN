...
To use dataset, unzip dataset in directory `./data/porto`, this dataset contains the road trajectory. （Use **Git LFS** or Download .zip in directory `./data/porto/porto_data.zip` from github website. Refer to [this issue](https://github.com/slzhou-xy/GREEN/issues/1)).
